		...
		<div class="box_a1">
				<form class="wanwu_form"  method="post" action="${rootPath}/member/auth_identity_edit_do" id="wanwuForm">
					...
					<div class="itembox">	
						...
						<div class="div_block">
							<p class="p_block reject_reason_p" style="width: 100%; display: none;"><label class="label_block">拒绝原因：</label>
								<input id="reject_reason" style="width: 567px" type="text" name="reject_reason" maxlength="200" class="txt required" value="" />
							</p>
						</div>
					</div>
					<p class="p_block p_btn">
						<input type="submit" class="btn_a btn_a1" name="btn_submit" id="ok" value="确 定" style="${info.id_status == 0 || info.id_status == 3 ? '' : 'display: none;'}"/>
					...
					<div class="div_block">
						<p class="p_block" style="width: 100%; text-align: center;">
							<a href="${info.id_front_img}" target="_blank"><img alt="正面" src="${info.id_front_img}" style="width: 600px;"></a>
							<a href="${info.id_back_img}" target="_blank"><img alt="反面" src="${info.id_back_img}" style="width: 600px;"></a>
							<a href="${info.id_handheld_img}" target="_blank"><img alt="手持" src="${info.id_handheld_img}" style="width: 600px;"></a>
						</p>
					</div>
				</form>
		</div>
