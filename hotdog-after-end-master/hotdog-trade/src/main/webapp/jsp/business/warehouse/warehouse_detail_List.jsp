...
<%@ include file="../../topForList.jsp"%>
	<div id="searchDiv" class="searchDiv">
		...
		<div class="searchField">
			<div class="searchFieldLbl">锁仓账户ID</div>
			<div class="searchFieldCtr">
				<input id="whAccountId" name="whAccountId" type="text" class="txt enterAsSearch" />
			</div>
		</div>
		<div class="searchField">
...
$(function(){
	...
	grid = $("#gridBox").ligerGrid({
		columns: [
			...
			{display:'锁仓账户ID',name:'whAccountId',width:80},
			...
			{display:'锁仓未释放资产',name:'preAccount',width:150},
			{display:'本次浮动资产',name:'flotAccount',width:120},
			{display:'操作时间',name:'updateTime',width:150},
		],
		 
        delayLoad: true, 
		rownumbers:true,
		url: "${rootPath}/a/getWarehouseDetailList",
		method: "get",
		sortName: 'id',
	   	sortOrder: 'desc',
	   	isSort: false
