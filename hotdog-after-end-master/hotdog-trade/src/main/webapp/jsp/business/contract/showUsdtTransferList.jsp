    ...
    $(function(){
        ...
        grid = $("#gridBox").ligerGrid({
            columns: [
                ...
                {display:'会员账号',name:'pName',width:180},
                {display:'推荐人',name:'parentName',width:120},
                {display:'业务员',name:'salesmanName',width:120},
                {display:'划转类型',name:'isoutCode',width:70},
                {display:'转出账户',name:'transOut',width:100},
                {display:'转入账户',name:'transIn',width:150},
                {display:'子公司',name:'contrSysLogin',width:100},
                {display:'金额',name:'cost',width:100},
                {display:'时间',name:'createtime',width:150}
            ],
            delayLoad: true,
            rownumbers:true,
            url: "${rootPath}/contract/showUsdtTransferList",
            method: "get",
            sortName: 'createtime',
            sortOrder: 'desc',
            isSort: false
