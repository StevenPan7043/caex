...
<div class="main_content">
	<div class="contbox_a1">
		<div class="box_a1">
			<form class="wanwu_form" method="post" action="${rootPath}/ca/editCurrencyAuth" id="wanwuForm">
				<input id="id" type="hidden" name="id" value="${info.id }" />
				<div class="itembox">
					<div class="div_block">
						<p class="p_block " style="width: 100%; ">
							<label class="label_block">会员：</label>
							<input id="mName" name="mName" value="${info.mName}" class="txt number required"
								   disabled/>
						</p>
					</div>
					...
					<div class="div_block" style="margin-top: 10px" id ="baseWQuota1">
