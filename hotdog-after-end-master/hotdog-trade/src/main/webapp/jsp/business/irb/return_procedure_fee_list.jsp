...
<%@ include file="../../topForList.jsp"%>
	...
	<div style="padding: 15px 20px;">
		<h3>返还总手续费: <span id="count" style="color: #00b07c;">10000</span></h3>
	</div>
...
$(function(){
	grid = $("#gridBox").ligerGrid({
		columns: [
			...
			{display:'会员当天交易手续费',name:'XXX',width:200},
			{display:'平台当天交易总手续费',name:'XXX',width:200},
			{display:'返还手续费',name:'XXX',width:120}
		],
