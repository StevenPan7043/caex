...
$(function () {
      grid = $("#gridBox").ligerGrid({
		columns: [
			...
			{display:'奖励数量',name:'teamBonus',width:100},
			{display:'奖励率',name:'bonusRate',width:100},
			{display:'分红日期',name:'bonusDate',width:100},
			{display:'伞下矿工总产量',name:'subBonusBase',width:150},
			{display:'伞下矿工总业绩',name:'subHashrateBase',width:150},
			{display:'团队奖励记录日志',name:'memo',width:300},
