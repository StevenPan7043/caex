...
(function ($)
{
    ...
    $.ligerui.controls.Accordion.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _render: function ()
        {
            ...
            $(".l-accordion-toggle", g.accordion).click(function ()
            {
                var togglebtn = $(this);
                if (togglebtn.hasClass("l-accordion-toggle-close"))
                {
                    ...
                    $(this).parents('div').next(".l-accordion-content")
                    .show(p.speed)
                    .siblings(".l-accordion-content:visible").hide(p.speed);
                    $(this).parents('div').siblings(".l-accordion-header").find(".l-accordion-toggle").removeClass("l-accordion-toggle-open").addClass("l-accordion-toggle-close");
                }
                else
                {
                    ...
                    $(this).parents('div').next(".l-accordion-content").hide(p.speed);
                } 
            });
            //init
