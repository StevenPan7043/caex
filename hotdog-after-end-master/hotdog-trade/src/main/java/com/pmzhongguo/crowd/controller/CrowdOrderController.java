 ...
 * @author: 十一
 */
@Api(value = "众筹项目订单接口", description = "众筹项目订单接口", produces = MediaType.APPLICATION_JSON_VALUE)
@CrossOrigin(origins = "*", maxAge = 3600)
@Controller
@RequestMapping("/crowd")
public class CrowdOrderController extends TopController{

    private static Logger logger = LoggerFactory.getLogger(CrowdOrderController.class);
