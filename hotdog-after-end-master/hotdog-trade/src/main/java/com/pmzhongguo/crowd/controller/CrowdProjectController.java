 ...
 * @author: 十一
 */
@Api(value = "众筹项目", description = "众筹项目接口", produces = MediaType.APPLICATION_JSON_VALUE)
@CrossOrigin(origins = "*", maxAge = 3600)
@Controller
@RequestMapping("/crowd")
public class CrowdProjectController extends TopController {

    private static Logger logger = LoggerFactory.getLogger(CrowdProjectController.class);
