...
@ApiIgnore
@Controller
@RequestMapping("backstage/crowd/job")
public class BackJobController extends TopController {

    private static Logger logger = LoggerFactory.getLogger(BackJobController.class);
