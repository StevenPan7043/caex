...
@Controller
@RequestMapping("/api/" + YTCTTransferController.c_name)
@ApiIgnore
public class YTCTTransferController extends TopController
{
    ...
    public static final String c_name = "ytct";
    ...
    public Resp fundTransferDeposit(@RequestBody ApiFundTransfer apiFundTransfer, HttpServletRequest request) {
        ...
        try {
            ...
            resp = fundTransferLogManager.addFundTransferLog(apiFundTransfer, member, c_name, ipAddr, OptSourceEnum.YTCT);
        } catch (Exception e) {
            // 异常
