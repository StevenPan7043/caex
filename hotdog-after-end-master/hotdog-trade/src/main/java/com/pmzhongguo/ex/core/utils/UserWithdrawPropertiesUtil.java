 ...
 * @Description
 */
public class UserWithdrawPropertiesUtil {

    private static Logger logger = LoggerFactory.getLogger(UserWithdrawPropertiesUtil.class);
    ...
    public UserWithdrawPropertiesUtil(String ... resourcesPaths)
    {
