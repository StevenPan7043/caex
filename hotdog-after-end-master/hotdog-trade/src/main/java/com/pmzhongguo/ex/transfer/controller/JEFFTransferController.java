...
@Controller
@RequestMapping("/api/" + JEFFTransferController.c_name)
@ApiIgnore
public class JEFFTransferController extends TopController
{
    ...
    public static final String c_name = "jeff";
    ...
    public Resp fundTransferDeposit(@RequestBody ApiFundTransfer apiFundTransfer, HttpServletRequest request) {
        ...
        try {
            ...
            resp = fundTransferLogManager.addFundTransferLog(apiFundTransfer, member, c_name, ipAddr, OptSourceEnum.JEFF);
        } catch (Exception e) {
            // 异常
