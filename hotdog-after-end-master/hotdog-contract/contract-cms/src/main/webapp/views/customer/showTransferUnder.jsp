...
<body>
	...
	<form action="/customer/showTransferUnder" id="seachFrom">
				...
				<tbody>
					<c:forEach items="${list }" var="l">
						<tr >
							...
							<td class="tc" ><fmt:formatNumber value="${l.transInSum }" pattern="#0.000000"/></td>
							<td class="tc" ><fmt:formatNumber value="${l.transOutSum }" pattern="#0.000000"/></td>
							<td class="tc" ><fmt:formatNumber value="${l.taxes }" pattern="#0.000000"/></td>
							<td class="tc" ><fmt:formatNumber value="${l.rates }" pattern="#0.000000"/></td>
							<td class="tc" ><fmt:formatNumber value="${l.totalBalance }" pattern="#0.000000"/> </td>
						</tr>
					</c:forEach>
				</tbody>
				<%--<tfoot>--%>
