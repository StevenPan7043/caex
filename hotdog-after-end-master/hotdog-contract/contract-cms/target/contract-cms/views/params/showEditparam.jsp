...
<article class="page-container">
	<form class="form form-horizontal" id="form-edit">
		<input type="hidden" name="key" value="${infos.keyval }">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">参数说明：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${infos.remark }" name="remark">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>参数值：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${infos.vals }" placeholder="参数值" name="val">
			</div>
		</div>
		<div class="row cl">
