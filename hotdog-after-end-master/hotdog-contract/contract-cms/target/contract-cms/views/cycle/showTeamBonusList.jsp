...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 周期交易 <span class="c-gray en">&gt;</span> 团队收益 <a
	...
	<form action="/cycle/showTeamBonusList" id="seachFrom">
				...
				<tbody>
					<c:forEach items="${pageInfo.list }" var="l">
						<tr >
							...
							<td class="tc">${l.level}</td>
							<td class="tc">${l.teamBonus}</td>
							<td class="tc">${l.bonusRate}</td>
							<td class="tc">${l.subBonusBase}</td>
