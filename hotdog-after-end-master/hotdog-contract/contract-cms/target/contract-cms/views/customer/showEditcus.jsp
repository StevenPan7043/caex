...
<article class="page-container">
	<form class="form form-horizontal" id="form-edit">
		<div class="Huialert Huialert-danger"><i class="Hui-iconfont">&#xe6a6;</i>会员资料修改，可以降手机号，邮箱设置为空，如果不存在手机号或邮箱则会员无法根据其中条件修改密码，找回密码</div>
		<input type="hidden" name="id" value="${cus.id }">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">手机号：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${cus.phone }" placeholder="会员注册手机号" name="phone">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>真实名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${cus.realname }" placeholder="会员真实名称" name="realname">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>证件号：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${cus.idcard }" placeholder="会员证件号" name="idcard">
			</div>
		</div>
