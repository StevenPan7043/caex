...
public class HttpUtils
{
    ...
    public static  String httpPostWithJSON(HttpClient client, String url, Map<String, String> headerMap, JSONObject jsonParam, String charsetName) throws Exception {
        try {
            HttpPost httpPost = new HttpPost(url);
            ...
            if (statusCode == 200) {
                ...
                throw new Exception("BITGO-POST远程请求失败：" + error);
            }
            return respContent;
        } catch (Exception e) {
            throw e;
