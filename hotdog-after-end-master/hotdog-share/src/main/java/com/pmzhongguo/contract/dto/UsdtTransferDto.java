...
import com.pmzhongguo.contract.contractenum.TransferTypeEnum;
...
public class UsdtTransferDto  {
    ...
    public void setTypeid(String typeid) {
        ...
        this.typeid = typeid;
        TransferTypeEnum enumByType = TransferTypeEnum.getEnumByType(Integer.valueOf(typeid));
        if (enumByType != null) {
    ...
    public String getContrSysLogin() {
        return contrSysLogin;
    }

    public void setContrSysLogin(String contrSysLogin) {
        this.contrSysLogin = contrSysLogin;
    }
