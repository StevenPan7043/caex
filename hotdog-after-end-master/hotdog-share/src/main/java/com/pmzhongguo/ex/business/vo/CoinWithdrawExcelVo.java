 ...
 * @author: 十一
 */
public class CoinWithdrawExcelVo
{
    ...
    @ExcelField(title = "虚拟币", align = 2, sort = 2)
    private String currency;//d_currency的currency
    @ExcelField(title = "提现数量", align = 2, sort = 4)
    private BigDecimal w_amount;//提现数量
    @ExcelField(title = "到账数量", align = 2, sort = 4)
    private BigDecimal w_toaccount;
    private BigDecimal w_fee;//手续费
    @ExcelField(title = "提现时间", align = 2, sort = 5)
    ...
    private String w_status_desc;//状态：0：待处理，1：已完成，2：已取消
    ...
    private String transfer_no_desc;  //划转标识
    // 附加字段
    ...
    public String getW_status_desc()
    {
        return w_status_desc;
    }

    public void setW_status_desc(String w_status_desc)
    {
        this.w_status_desc = w_status_desc;
    }

    public String getTransfer_no_desc()
    {
        return transfer_no_desc;
    }

    public void setTransfer_no_desc(String transfer_no_desc)
    {
        this.transfer_no_desc = transfer_no_desc;
    }
    public BigDecimal getW_toaccount() {
        return w_toaccount;
    }

    public void setW_toaccount(BigDecimal w_toaccount) {
        this.w_toaccount = w_toaccount;
    }
}
