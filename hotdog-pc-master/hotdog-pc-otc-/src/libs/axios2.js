...
const messageArr = [
  ...
  'LANG_LOCK_TYPE_ERROR',
  'LANG_ERROR_OPERATION_OBJECT',
  ...
  'TRADE_COMPLAINING',
  'ERROR_OTC_CURRENCY',
  'ACCOUNTTYPE_ONLY_ONE',
  'LANG_REPEAT_ERROR',
  'LANG_ERROR_STATUS',
  'LANG_NO_RECORD',
  'LANG_OPERTION_FAIL',
  'RELATION_CUSTOMER_SERVICE',
  'ONLY_MOBILE_CUSTOMER',
  'SELF_TRADE_ERROR',
  'COMPLETE_OTHER_TRADE_PAY',
  'CANCEL_TRADE_OVERMUCH',
  'LANG_ERROR_DATA',
  'LANG_ERROR_OPERTION',
  'ORDER_TYPE_ONLY_TWO',
  'LANG_ILLEGAL_SUBMIT_DATA',
  ...
  (response) => {
    if (response.data) {
      ...
      if (res.state === 1) {
        ...
        const index = message_arr.indexOf(res.msg);
        if (index === -1) {
          Message.error({
            // content: res.msg,
            content: '未知错误',
